...
garden_display = {
    ...
    "Zijtuin": "Side",
    "Tuin rondom": "Around",
    "Terras/patio": "Terrace/Patio",
    "Meerdere tuinen": "Multiple",
...
toilet_display = {
    ...
    "1 bad, 2+ toilet": "1 bath, 2+ toilet",
    "2+ bad, 0 toilet": "2+ bath, 0 toilet",
    "2+ bad, 1 toilet": "2+ bath, 1 toilet",
    "2+ bad, 2+ toilet": "2+ bath, 2+ toilet",
}
floors_display = {
    "1": "1",
    "2": "2",
...
with col1:
    ...
    rooms = st.number_input(
        ...
        value=5,
        step=1,
        help="Totaal aantal kamers (incl. woon-/slaapkamers).",
    )
...
with st.expander("Aanvullende woningkenmerken (optioneel)"):
    ...
    if dataset_available:
        ...
        st.caption(
            "Meer woningkenmerken worden zichtbaar na het inladen van een dataset "
            "via de kalibratie."
        )
...
with st.expander("Renovatieplan (optioneel)"):
    ...
    with col6:
        roof_budget = st.number_input(
            "Dak/kozijnen (hoger rendement)",
            min_value=0.0,
            max_value=300000.0,
            value=0.0,
            step=1000.0,
    ...
    weighted_total = (
        ...
        + roof_budget * weights.get("roof_windows", 1.0)
